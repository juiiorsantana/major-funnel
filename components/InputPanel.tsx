...
export const InputPanel: React.FC<InputPanelProps> = ({ state, onUpdate, campaignType, onCampaignTypeChange }) => {
    ...
    return (
        <motion.section
            ...
            initial="hidden"
            animate="show"
            className="col-span-12 lg:col-span-3 flex flex-col bg-white/95 backdrop-blur-sm p-5 rounded-3xl border border-slate-200/60 shadow-xl shadow-slate-200/40 overflow-y-auto"
        >
            {/* Campaign Type Toggle */}
            <motion.div variants={item} className="mb-6">
                <label className="text-[9px] font-bold text-slate-400 uppercase tracking-[0.2em] flex items-center mb-3">
                    <svg className="w-3 h-3 mr-2 text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-5">
                ...
                <motion.div variants={item} className="space-y-3">
                    <label className="text-[9px] font-bold text-slate-400 uppercase tracking-[0.15em] flex items-center">
                        <svg className="w-3 h-3 mr-2 text-tech-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
